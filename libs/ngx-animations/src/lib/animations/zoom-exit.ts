...
export function zoomOutDown(time: number): (AnimationStyleMetadata | AnimationAnimateMetadata)[] {
  ...
  return [
    style({ }),
    animate(t, style({ opacity: '0.5', transform: 'scale3d(0.475, 0.475, 0.475) translate3d(0, 0, 0)', 'animation-timing-function': 'cubic-bezier(0.55, 0.055, 0.675, 0.19)' , offset: .4 })),
...
export function zoomOutLeft(time: number): (AnimationStyleMetadata | AnimationAnimateMetadata)[] {
  ...
  return [
    style({ }),
    animate(t, style({ opacity: '0.5', transform: 'scale3d(0.475, 0.475, 0.475) translate3d(42px, 0, 0)' , offset: .4 })),
...
export function zoomOutUp(time: number): (AnimationStyleMetadata | AnimationAnimateMetadata)[] {
  ...
  return [
    style({ }),
    animate(t, style({ opacity: '0.5', transform: 'scale3d(0.475, 0.475, 0.475) translate3d(0, 60px, 0)', 'animation-timing-function': 'cubic-bezier(0.55, 0.055, 0.675, 0.19)' , offset: .4 })),
    animate(t, style({ opacity: '0', 'transform-origin': 'center bottom', transform: 'scale3d(0.1, 0.1, 0.1) translate3d(0, -2000px, 0)', 'animation-timing-function': 'cubic-bezier(0.175, 0.885, 0.32, 1)' })),
  ];
}
